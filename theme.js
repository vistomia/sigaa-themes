window.addEventListener('DOMContentLoaded', async () => {
    ...
    } else if (currentPageUrl === "https://si3.ufc.br/sigaa/telaAvisoLogon.jsf") {
        document.querySelector("input:nth-child(1)").innerText = "Continuar";
    } else if (currentPageUrl === "https://si3.ufc.br/sigaa/paginaInicial.do") {
    ...
    } else if (currentPageUrl === "https://si3.ufc.br/sigaa/portais/discente/discente.jsf") {
